...
import Spaces_Screen from '../Bottom_Screen/Spaces_Screen';
import Setting from '../Drawer_Screen/Setting';
import CustomDrawer from '../Drawer_Screen/CustomDrawer';
import { FontAwesome,Feather,SimpleLineIcons,MaterialCommunityIcons,MaterialIcons,Ionicons } from "@expo/vector-icons";
...
function Spaces() {
  return (
    ...
    >        
      <Drawer.Screen name="Spaces" component={Spaces_Screen}
       options={({navigation}) =>({
                ...
                drawerIcon: () => (<MaterialIcons name="workspaces-outline" size={24} color="black" style ={{left: 5}} />)
                , drawerLabelStyle: {
                    fontSize: 17,
                    right: 8
                }
