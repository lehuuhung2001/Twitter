...
import Notification_Screen from '../Bottom_Screen/Notification_Screen';
...
function Notification() {
  return (
    ...
    >        
      <Drawer.Screen name="Notification" component={Notification_Screen}
       options={({navigation}) =>({
                ...
                drawerIcon: () => (<Ionicons name="md-notifications-outline" size={24} color="black" style ={{left: 5}} />)
                , drawerLabelStyle: {
                    fontSize: 17,
                    right: 8
                }
