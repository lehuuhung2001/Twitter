...
import Messages_Screen from "../Bottom_Screen/Messages_Screen";
...
function Messages() {
  return (
    ...
    >        
      <Drawer.Screen name="Messages" component={Messages_Screen}
       options={({navigation}) =>({
                ...
                drawerIcon: () => (<MaterialCommunityIcons name="email-outline" size={24} color="black" style ={{left: 5}} />)
                , drawerLabelStyle: {
                    fontSize: 17,
                    right: 8
                }
